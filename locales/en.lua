Locales['en'] = {
  ...
  ['armory'] = 'اسلحه خانه',
  ['open_armory'] = 'دکمه E را فشار دهید تا به اسلحه خانه دسترسی پیدا کنید',
  ['armory_owned'] = 'owned',
  ['armory_free'] = 'رایگان',
  ['armory_item'] = '$%s',
  ...
  ['helicopter_prompt'] = 'دکمه E را فشار دهید تا به پارکینگ هلیکوپتر ها دسترسی پیدا کنید.',
  ['shop_item'] = '$%s',
  ...
  ['impound_prompt'] = 'شما میتوانید به دکمه E ارسال ماشین به پارکینگ را متوقف کنید',
  ...
  ['owner'] = 'مالک: %s',
  -- Boss Menu
  ['open_bossmenu'] = 'با فشار دادن دکمه E به منوی مدیریت دسترسی پیدا کنید',
